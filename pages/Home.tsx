...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen relative bg-black selection:bg-zinc-800 selection:text-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12 md:py-24">
        ...
        <header className="text-center mb-32 space-y-8 animate-fade-in-up pt-20">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-zinc-400 mb-6 hover:bg-white/10 transition-colors cursor-default backdrop-blur-sm">
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto font-light leading-relaxed">
            The ultimate collection of <span className="text-zinc-200 font-medium">high-performance</span>, interaction-heavy buttons.
            <br className="hidden md:block" />
            Designed to <span className="text-zinc-200 font-medium">elevate</span> your user interface.
          </p>

          <div className="flex items-center justify-center gap-4 pt-8">
            <a
              href="#buttons"
              className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-zinc-400 focus:ring-offset-2 focus:ring-offset-zinc-50"
            >
...
const CategorySection: React.FC<{
  ...
  <section className="animate-fade-in">
    <div className="w-full p-6 mb-10 rounded-2xl bg-zinc-900/40 border border-white/10 backdrop-blur-md flex flex-col md:flex-row md:items-center justify-between gap-6 hover:border-white/20 transition-all duration-300 group">
      <div className="flex items-center gap-5">
        <div className="p-3.5 rounded-xl bg-white/5 border border-white/10 text-zinc-400 group-hover:text-white group-hover:bg-white/10 transition-all duration-300">
          {icon}
        </div>
        <div>
          ...
          {description && (
            <p className="text-zinc-400 text-sm md:text-base font-light mt-1 group-hover:text-zinc-300 transition-colors">
              {description}
            </p>
          )}
        </div>
      </div>
      <div className="text-xs font-mono text-zinc-500 uppercase tracking-widest bg-black/20 px-4 py-2 rounded-lg border border-white/5">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      {buttons.map((btn) => (
        ...
        >
          ...
          <div className="absolute top-4 right-4 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300 z-20">
            <button
              onClick={() => onSelect(btn)}
              className="p-2.5 rounded-xl bg-zinc-900/90 border border-white/10 text-zinc-400 hover:text-white hover:border-white/20 hover:scale-110 transition-all shadow-lg shadow-black/50 backdrop-blur-md"
              title="View Code"
            >
