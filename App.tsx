...
import { Github, Code2, Copy, Check, X, Sparkles, Layers, Box, Terminal, Zap, Type } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12 md:py-24">
        ...
        <header className="text-center mb-32 space-y-8 animate-fade-in-up">
          ...
          <div className="flex items-center justify-center gap-4 pt-4">
            <a href="https://github.com/prateekraiger" target="_blank" rel="noreferrer" 
        ...
        <div className="space-y-32">
          ...
          <CategorySection 
            ...
            buttons={buttonCollection.filter(b => b.category === 'interaction')}
            onSelect={setSelectedButton}
          />
          ...
          <CategorySection 
            ...
            buttons={buttonCollection.filter(b => b.category === 'typography')}
            onSelect={setSelectedButton}
          />
        ...
        <footer className="mt-40 border-t border-white/5 pt-12 pb-8 flex flex-col md:flex-row justify-between items-center gap-6 text-zinc-600 text-sm">
          ...
          <div className="flex items-center gap-8">
            <span className="hover:text-zinc-400 cursor-pointer transition-colors">License</span>
            <span className="hover:text-zinc-400 cursor-pointer transition-colors">Docs</span>
            <a href="https://github.com/prateekraiger" className="hover:text-zinc-400 transition-colors">GitHub</a>
          </div>
        </footer>
      </div>
    ...
    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12 border-b border-white/5 pb-6">
      <div className="flex items-start gap-4">
        ...
        <div>
            ...
            {description && <p className="text-zinc-500 mt-1 font-light">{description}</p>}
        </div>
      </div>
...
const CodeModal: React.FC<{ button: ButtonItem; onClose: () => void }> = ({ button, onClose }) => {
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-[#09090b]">
          <div className="flex items-center gap-3">
            ...
            <div>
                <h3 className="text-sm font-semibold text-white">{button.name}</h3>
